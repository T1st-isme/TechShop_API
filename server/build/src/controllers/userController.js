...
const userSignup = asyncHandler(async (req, res) => {
  ...
  // check user
  const exisitingUser = await userModels.findOne({
    email
  });
  // exisiting user
  if (exisitingUser) {
...
export { userLogin, userSignup, userLogout, allUsers, getUserDetails, updateUser, deleteUser, userProfile, createUser, updateUserProfile };