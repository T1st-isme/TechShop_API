...
import { addOrder, createPaymentLink, deleteOrder, getOrder, getOrderDetail, getOrders, myOrder, updateOrder, createOrder, updatePaymentStatus } from "../controllers/OrderController.js";
...
router.put("/update-payment-status/:orderCode", requiredSignin, updatePaymentStatus);

// admin route
router.get("/admin/get-orders", requiredSignin, getOrders);
router.route("/admin/:id").put(requiredSignin, updateOrder).delete(requiredSignin, deleteOrder);
